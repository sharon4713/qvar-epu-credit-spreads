...
### Dataset
- **Variables:** EPU (News-Based Policy Uncertainty Index), BAA corporate spreads (Moody's), yield curve slope (T10Y2Y), BBB-AAA quality spread, EPU×BBB-AAA interaction term
...
3. **Scenario Translation** — Convert regulatory scenarios (CCAR, ICAAP) to EPU levels, then estimate capital impact using model coefficients.
